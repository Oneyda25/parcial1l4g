...
def inicio():
  ...
  datos=cursor.fetchall()#La variable datos almacena todos los datos de la consulta
...
def agregarProducto():
  if request.method=='POST':
    ...
    db.connection.commit()#Ejecuta la consulta
    flash("Producto agregado satisfactoriamente")#Envia un mensaje desde el servidor
    return redirect(url_for("inicio"))#Redirecciona a la ruta principal("/")
